        ...
        (re = (function () {
          ...
          return (
            ...
            (e._getItemIndex = function (e) {
              return (
                (this._items = e && e.parentNode ? [].slice.call(e.parentNode.querySelectorAll($)) : []),
                  ...
                  if (0 < i)
                    for (var r = 0; r < i; r++) {
                      var o = this._triggerArray[r],
                        s = we.getSelectorFromElement(o)
                      if (null !== s)
                        oe([].slice.call(document.querySelectorAll(s))).hasClass(de) ||
  ...
  function st(e, n, t) {
    return (
      (void 0 === t
        ...
        e.enabled &&
          xe(t) &&
          ((n.offsets.popper = Ge(n.offsets.popper)), (n.offsets.reference = Ge(n.offsets.reference)), (n = t(n, e)))
      }),
      n
    )
  }
                ...
                secondary: function (e) {
                  ...
                  return (
                    u[e] > l[e] &&
                      ...
                      (n = Math.min(u[t], l[e] - ('right' === e ? u.width : u.height))),
                    Ve({}, t, n)
                  )
                }
              }
        ...
        Ye(o, [
          ...
          },
          {
            ...
            value: function () {
              return function () {
                this.state.eventsEnabled ||
                  (this.state = ut(this.reference, this.options, this.state, this.scheduleUpdate))
              }.call(this)
            }
          },
          {
        ...
        return (
          ...
          (c._jQueryInterface = function (t) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new c(this, 'object' == typeof t ? t : null)), Tt(this).data(Dt, e)), 'string' == typeof t)
              ) {
                  ...
                  if (
                    ...
                    Tt(r).trigger(l),
                      l.isDefaultPrevented() ||
                        ('ontouchstart' in document.documentElement &&
                          Tt(document.body).children().off('mouseover', null, Tt.noop),
          ...
          (c._dataApiKeydownHandler = function (e) {
            if (
              (/input|textarea/i.test(e.target.tagName)
                ? !(
                    32 === e.which ||
                    (27 !== e.which && ((40 !== e.which && 38 !== e.which) || Tt(e.target).closest(Ut).length))
                  )
                : Nt.test(e.which)) &&
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (e || ((e = new i(this, t)), yn(this).data(bn, e)), 'string' == typeof n)
              ) {
                if ('undefined' == typeof e[n]) throw new TypeError('No method named "' + n + '"')
                e[n]()
              }
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (e || ((e = new i(this, t)), Un(this).data(qn, e)), 'string' == typeof n)
              ) {
                if ('undefined' == typeof e[n]) throw new TypeError('No method named "' + n + '"')
                e[n]()
              }
