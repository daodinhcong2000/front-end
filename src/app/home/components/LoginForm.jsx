...
const LoginForm = (props) => {
  ...
  return (
    ...
    >
      ...
      <Row>
        <Col span={12}>
          <Button span={12} type="link" htmlType="button" onClick={handleRegister} style={{ width: '100%' }}>
            Chưa có tài khoản?
          </Button>
        </Col>
        <Col span={12}>
          <Button span={12} offset={12} type="link" htmlType="button" onClick={handleForgot} style={{ width: '100%' }}>
            Quên mật khẩu?
          </Button>
        </Col>
      </Row>
