...
const ProductItem = (props) => {
  ...
  return (
    <div
      ...
      style={{ textAlign: 'center', padding: '5px', background: 'mintcream' }}
      onClick={(e) => {
    ...
    >
      ...
      <Row>
        ...
        <Col span={14}>
          <Button type="link" href="/seller" style={{ textDecoration: 'none' }}>
            <b>{shop}</b>
          </Button>
        </Col>
      </Row>
      ...
      <Row>
        ...
        <Col span={8} style={{ verticalAlign: '', fontSize: '90%' }}>
          ...
          <Row>
            <Col span={24}>
              <h6 style={{ color: 'silver', textDecoration: 'line-through' }}>${price}</h6>
            </Col>
          </Row>
        </Col>
        <Col span={8}>
